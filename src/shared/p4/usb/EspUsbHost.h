...
// Vendored EspUsbHost (apple2esp32 fork) PATCHED for Arduino-ESP32 core 3.x / ESP-IDF 5.x on the
// ESP32-P4. Compiled only on the P4 (BOARD_INPUT_USB + BOARD_PANEL_DSI); empty elsewhere so the S3
// keeps using its external IDF-4.4 fork (<EspUsbHost.h>). See src/shared/p4/README.md.
#include "../../../../board.h"
#if BOARD_INPUT_USB && BOARD_PANEL_DSI

#include <Arduino.h>
#include <usb/usb_host.h>
#include <class/hid/hid.h>
#include <usb/usb_types_ch9.h>   // IDF5: ch9 descriptor types/constants (was <rom/usb/usb_common.h>)

// The fork used IDF-4.4 descriptor-type constant names; map them to the IDF-5.x names.
#ifndef USB_DEVICE_DESC
#define USB_DEVICE_DESC          USB_B_DESCRIPTOR_TYPE_DEVICE
#define USB_CONFIGURATION_DESC   USB_B_DESCRIPTOR_TYPE_CONFIGURATION
#define USB_STRING_DESC          USB_B_DESCRIPTOR_TYPE_STRING
#define USB_INTERFACE_DESC       USB_B_DESCRIPTOR_TYPE_INTERFACE
#define USB_ENDPOINT_DESC        USB_B_DESCRIPTOR_TYPE_ENDPOINT
#define USB_INTERFACE_ASSOC_DESC USB_B_DESCRIPTOR_TYPE_INTERFACE_ASSOCIATION
...
#endif // BOARD_INPUT_USB && BOARD_PANEL_DSI
